...
#----------------------------------------- new data added
#----------do well to check that the values are appropriately defined e.g workdata3. num_trait3, TRYdata6 etc---------


# Marijn sent some TRY data, I have carried out some analysis to process the data----
...
# Export the data into a CSV file
output_file = file.path(tempdir(), "workdata_wider_traits_Marijn.csv")
rtry_export(num_traits_georef_wider3, output_file)



# Export the data into a CSV file
output_file = file.path(tempdir(), "workdata_traits_Marijn.csv")
